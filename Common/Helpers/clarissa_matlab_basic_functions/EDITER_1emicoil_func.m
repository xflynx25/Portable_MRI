function [corr_img_opt_toep,gksp]   = EDITER_1emicoil_func(datafft, datanoise_fft_1)
...
corr_img_opt_toep = ifftshift(ifftn(fftshift(gksp)));
...
% figure(101);
% subplot(131);
% uncorr = ifftshift(ifftn(ifftshift(datafft)));
