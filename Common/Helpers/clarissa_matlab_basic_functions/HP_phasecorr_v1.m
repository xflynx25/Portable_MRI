...
dat_nav_pos = Ms_reorder_pos([29,30],:,:);
...
phaseramp_3d = repmat(reshape(phaseramp,[1,256,Npe_all]), [Necho, 1, 1]);
...
data0 = permute(Ms_pcorr_pos,[2,3,1]);
dataFID= data0(:,:,1:1:end);
dataSpec= data0(:,:,2:1:end);
