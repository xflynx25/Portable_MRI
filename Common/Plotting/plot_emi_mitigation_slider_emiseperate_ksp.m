function plot_emi_mitigation_slider_emiseperate_ksp(combined_data, N, slice_type, square_plot, scale_param)
    ...
    data2d = abs(primary_data); %nothing in place for the slice type
    ...
    for detector = 2:num_detectors
        ...
        emi_transformed = abs(detector_data); 
    ...
    I3D_Editer = abs(corrected_ksp_3d);

    % Create figure and axes
    title = sprintf('KSPACE Slice Viewer - Scale Param: %g', scale_param);
