...
function [SNR, intraRMS, interRMS, raw1, img1, raw2, img2] = repeat_evaluation(processed_data_dim5, emi_func, raw_func, use_saved_coords)
    ...
    [SNR, intraRMS, interRMS] = major_metrics(raw1, img1, raw2, img2, use_saved_coords);
end 